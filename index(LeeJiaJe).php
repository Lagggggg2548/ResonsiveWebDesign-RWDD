    ...
    <body>
        <nav>
            ...
            <div class="sidebar">
                ...
                <a style="color: white;background-color:#1f1e1e;padding:0px 20px 0px 20px;margin-left:20px" class="Homelink" href="index(LeeJiaJe).php"><strong>TimeHelperEXE</strong></a>
                ...
                <a style="margin-right: auto"href="">Settings</a>
                <a href="sessionquit.php">Sign out</a>
            </div>
        </nav>
